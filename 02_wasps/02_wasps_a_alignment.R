...
# set of specimen IDs
IDlist <- tools::file_path_sans_ext(dir("02_wasps/original_images/", ".jpg"))

# make list with images
imageList <- makeList(IDlist, type = "image",
                      prepath = "02_wasps/original_images/",
                      extension = ".jpg")

# make list with landmarks
landmarkList <- makeList(IDlist,
                         type = "landmark",
                         prepath = "02_wasps/landmarks/",
...
mask1 <- read.table("02_wasps/masks/polistes_05_mask.txt", header = FALSE)
mask2 <- read.table("02_wasps/masks/polistes_05_Lantenna.txt", header = FALSE)
mask3 <- read.table("02_wasps/masks/polistes_05_Rantenna.txt", header = FALSE)
...
#save aligned faces
saveRDS(imageList_aligned, file = '02_wasps/rds_files/imageList_aligned.rds')
