...
imageList_aligned <- readRDS("02_wasps/rds_files/imageList_aligned.rds")
...
saveRDS(wasp_palette, "02_wasps/rds_files/palette.rds")
...
impose_list <- lapply(imgs, function(i) imposeColors(i, wasp_palette, 
                                                     ...
                                                     plotting = FALSE))
saveRDS(impose_list, "02_wasps/rds_files/recolorize_fits.rds")
...
# and save
saveRDS(patternize_list, "02_wasps/rds_files/patternize_list.rds")
