# bookkeeping
library(patternize)
patternize_list <- readRDS("05_wasps/rds_files/patternize_list.rds")
source("05_wasps/patPCA_total.R")
...
images <- lapply(dir("05_wasps/original_images/", full.names = TRUE),
                 readImage)
