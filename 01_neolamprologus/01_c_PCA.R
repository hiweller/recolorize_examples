...
kmeans_std <- readRDS("01_neolamprologus/rds_files/kmeans_standard.rds")
kmeans_aggregate <- readRDS("01_neolamprologus/rds_files/kmeans_aggregate.rds")
extent_list <- readRDS("01_neolamprologus/rds_files/image_extents.rds")
...
plot(neolamp_pca_ks$x[, 1:2],
     ...
     col = c("gold", "purple")[factor(sp)],
     cex = 6, lwd = 2,
     main = "K-means (generic implementation)")
