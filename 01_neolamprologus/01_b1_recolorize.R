...
saveRDS(imgs, "01_neolamprologus/rds_files/image_arrays.rds")

# save raster extents for later conversion:
extent_list <- lapply(imageList_aligned, extent)
saveRDS(extent_list, "01_neolamprologus/rds_files/image_extents.rds")
...
# in a list:
# saveRDS(rc_list, "01_neolamprologus/rds_files/recolorize_list_practice.rds")
...
# This example is the most complex of the bunch, which is why batch processing
...
rc_list <- readRDS("01_neolamprologus/rds_files/recolorize_list.rds")
